 ...
 * 
 * &gt;&gt; sqlite3 /data/data/com.example.aula04exemplobancodados/databases/banco_carro
 * 
...
public class RepositorioCarro {
	...
	// Nome do banco
	private static final String NOME_BANCO = "banco_carros";
	// Nome da tabela
	...
	public Carro buscarCarro(long id) {
		...
		Cursor c = db.query(true, NOME_TABELA, Carro.colunas, 
	...
	public Cursor getCursor() {
		try {
			...
			Log.e(TAG, "Erro ao buscar os carros: " + e.toString());
			return null;
		}
	}
	...
	public Carro buscarCarroPorNome(String nome) {
		...
		try {
			...
			Log.e(TAG, "Erro ao buscar o carro pelo nome: " + e.toString());
			return null;
		}
