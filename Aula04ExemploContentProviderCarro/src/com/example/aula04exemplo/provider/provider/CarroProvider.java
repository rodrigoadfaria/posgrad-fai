package com.example.aula04exemplo.provider.provider;

import java.util.HashMap;

import com.example.aula04exemplobancodados.Carro;
import com.example.aula04exemplobancodados.RepositorioCarro;
import com.example.aula04exemplobancodados.RepositorioCarroScript;
...
/**
 * ---------------------------------------------------- URI:
 * content://com.example.bancodados.provider.carro/carros
 * content://com.example.bancodados.provider.carro/carros/1
 * ----------------------------------------------------
 * 
...
public class CarroProvider extends ContentProvider {
	...
	// Utilizada para validar as expressões regulares
	// sobre a Uri
